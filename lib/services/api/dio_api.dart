...
import 'package:mobile_app/model/get_versions_response.dart';
import 'package:mobile_app/model/group_by_count_response.dart';
import 'package:mobile_app/model/login_request.dart';
import 'package:mobile_app/model/system_settings_response.dart';
    ...
    try {
      ...
      if (e is DioError) {
        ...
        if (error is SocketException) {
          ...
          throw ErrorResponse(statusMessage: e.response!.statusMessage);
        }
      } else {
        throw e;
      }

...
import 'package:mobile_app/views/awesome_bar/awesome_bar_viewmodel.dart';
import 'package:mobile_app/widgets/card_list_tile.dart';
        ...
        if (model.error != null) {
          ...
          return Scaffold(
            ...
            body: Padding(
              ...
              child: model.recentSearchesMode
                  ? RecentSearches(

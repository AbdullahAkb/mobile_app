class UploadedFileResponse {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['message'] = uploadedFile.toJson();
    return data;
  }
}
...
class UploadedFile {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_home_folder'] = isHomeFolder;
    data['is_attachments_folder'] = isAttachmentsFolder;
    data['file_size'] = fileSize;
    data['file_url'] = fileUrl;
    data['folder'] = folder;
    data['is_folder'] = isFolder;
    data['attached_to_doctype'] = attachedToDoctype;
    data['attached_to_name'] = attachedToName;
    data['content_hash'] = contentHash;
    data['uploaded_to_dropbox'] = uploadedToDropbox;
    data['uploaded_to_google_drive'] = uploadedToGoogleDrive;

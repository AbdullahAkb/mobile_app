...
class DesktopPageMessage {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['allow_customization'] = allowCustomization;
    return data;
  }
}
...
class ShortcutItem {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['type'] = type;
    data['link_to'] = linkTo;
    data['doc_view'] = docView;
    data['label'] = label;
    data['icon'] = icon;
    data['restrict_to_domain'] = restrictToDomain;
    data['stats_filter'] = statsFilter;
    data['color'] = color;
    data['format'] = format;
    data['doctype'] = doctype;
    data['is_query_report'] = isQueryReport;
    return data;
  }
}
...
class CardItemLink {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['doctype'] = doctype;
    data['is_query_report'] = isQueryReport;
    data['incomplete_dependencies'] = incompleteDependencies;
    data['icon'] = icon;
    data['link_to'] = linkTo;
    return data;
  }
